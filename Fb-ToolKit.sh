...
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" HELPER STUDIO  [FR13ND8]"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" Touseef Ali"$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ [KINGLEAGUE] [Github] [HelperStudio]"$i"  |"
echo $i" |"$cy"            ~ [cyber] [%MR.S%] [AldykaPrygh]"$i" |"
echo $i" |"$pu" YOUTUBE CHANNEL :"$ku" HELPER STUDIO"$i"             |"
echo $i" |"$pu" made by :"$ku" Kingleague"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
...
sleep 2
echo $cy"THANK YOU FOR USING OUR TOOL"
sleep 2
echo $i"If You Have Mistakes You Can Ask Me"
sleep 2
echo $ku"YT CHANNEL :"$i" Helper Studio"
echo $ku"Made By :"$i" Kingleague"
sleep 2
echo $pur">> Thanks For Using <<"
exit
fi